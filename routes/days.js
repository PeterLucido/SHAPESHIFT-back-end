...
router.put('/:dayId/notes', checkAuth, daysCtrl.updateNote)
router.put('/:dayId/sleep', checkAuth, daysCtrl.updateSleep)
router.put('/:dayId/meals', checkAuth, daysCtrl.updateMeal)
router.put('/:dayId/exercise', checkAuth, daysCtrl.updateExercise)
